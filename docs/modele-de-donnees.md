...
**État vérifié le 10 septembre 2026.** La base déployée porte **78 tables** (vérifié par requête
...
Les 78 tables déployées ont RLS active — vérifié sur la base déployée, aucune exception. 184
