...
| [modele-de-donnees.md](modele-de-donnees.md) | Les 85 tables par domaine, leurs relations, les clés d'isolation | Développeurs base de données |
...
| [temps-et-couverture-accident.md](temps-et-couverture-accident.md) | Les segments de temps payables, le découpage des vacations, et ce que la couverture accident attend encore d'une source légale |
| [conventions-collectives-sources.md](conventions-collectives-sources.md) | Ce que le corpus contient, et quelle norme s'applique dans les secteurs sans convention sectorielle |
