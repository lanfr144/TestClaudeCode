...
catalogue lui aussi rafraîchi : **les deux portent les 78 tables de la base déployée**, 95
...
- [modele-de-donnees.md](modele-de-donnees.md) — les 78 tables de la base déployée, domaine par domaine (le schéma traduit ici, `schema/catalogue.json`, n'en porte encore que 47 : voir « Le schéma portable » dans [architecture.md](architecture.md))
